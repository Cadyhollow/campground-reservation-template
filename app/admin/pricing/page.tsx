          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-3">
              ...
              <input
                ...
                placeholder="e.g. Fourth of July Weekend, Summer Peak"
                value={form.name}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {targetLabel(rule)} · {rule.start_date} → {rule.end_date} · Priority {rule.priority}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-green-700 font-semibold">${(rule.nightly_rate / 100).toFixed(2)}/night</span>
                <button
