...
export async function getBookingPageData(
  ...
  // The same named column list the browser used to send, unchanged. It is already the page's
  // real appetite, so nothing new is exposed and nothing needed goes missing.
